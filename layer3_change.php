...
<html lang="en">
	<head>
		<meta charset="utf-8">
		<title>Graphical User Authentication | Change Layer 3</title>
...
var name = img.src;
window.location.href = "layer4_change.php?var=" + name;
}
					...
					<div class="span12">													
						<div class="row">
							<div class="" style=" margin-left:50px; margin-top:20px">
								<h4 class="title ">
									<span class="pull-left"><span class="text"><span class="line"> <strong>Change Sequence: Layer 3|5</strong></span></span></span>
