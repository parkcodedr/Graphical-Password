...
if (@$_SESSION['selectagain']==1){
    $msg.='<font color="red" size="3px"><br>Your last selection sequence of images was wrong ! Start Fresh again !</font>';
...
<html lang="en">
	<head>
		<meta charset="utf-8">
		<title>Graphical User Authentication | Layer 1</title>
					...
					<div class="span12">													
						<div class="row">
							<div class="" style=" margin-left:50px; margin-top:20px">
								<h4 class="title ">
									<span class="pull-left"><span class="text"><span class="line"> <strong>Login: Layer 1|5</strong></span></span></span>
